...
<form method="POST" use:enhance class="grid gap-4">
	...
	{#if aiSuggested}
		<div class="-mb-2 flex items-center gap-1.5 text-xs text-muted-foreground">
			...
			<span>AI-suggested categories and tags below — adjust as needed.</span>
		</div>
	{/if}
	...
	<div class="grid gap-1.5">
		...
		<p class="text-xs text-muted-foreground">Type and press Enter to add. Suggestions appear as you type.</p>
	</div>
